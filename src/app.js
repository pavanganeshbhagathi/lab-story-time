...
function moreAboutKaren(parents, noOfSiblings, isNuclearFamily) {
  parentcheck = typeof parents;
  noOfSiblingscheck = typeof noOfSiblings;
  isNuclearFamilycheck = typeof isNuclearFamily;
  if (
    parentcheck == "string" &&
    noOfSiblingscheck == "number" &&
    isNuclearFamilycheck == "boolean"
  ) {
    return true;
  } else {
    return false;
